...
<head>
    ...
    <style>
        /* Copia los mismos estilos de tu cronograma.blade.php */
...
<div class="a4-container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>S/ {{ number_format($venta->lote->area_m2 * $venta->lote->precio_m2, 2) }}</td>
                ...
                <tr style="font-weight: bold;">
                    ...
                    <td>S/ {{ number_format($ventas->sum(function($v) { return $v->lote->area_m2 * $v->lote->precio_m2; }), 2) }}</td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $r->nro_cuota }}</td>
                <td>{{ date('Y-m-d', strtotime($r->fecha_pago)) }}</td>
                <td>{{ number_format($r->saldo, 2) }}</td>
                <td>{{ number_format($r->interes, 2) }}</td>
                <td>{{ number_format($r->amortizacion, 2) }}</td>
